                    ...
                    <>
                        ...
                        <div class="col-md-6 col-sm-6 col-sm-pull-6">
                            <div class="mu-hero-left">
                                {props.book.author ? (<>
                                    <h1>author : {props.book.author.username}</h1>
                                    <h1>title : {props.book.title}</h1>
                                    <h1>number pages: {props.book.pages.length}</h1>
                                </>) : <></>}
                                ...
                                if (index == 0) {
                                    ...
                                    return <>
                                        <div class="flip" id={`p${Math.ceil((ele.number+1)/2)}`}>
                                            <div class="back">
                                            <div dangerouslySetInnerHTML={{ __html: props.book.pages[index + 1].content }}></div>
